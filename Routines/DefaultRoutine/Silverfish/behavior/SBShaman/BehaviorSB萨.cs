...
namespace HREngine.Bots
{
    ...
    public class BehaviorSBShaman : Behavior
    {
        public override string BehaviorName() { return "SB萨"; }
        ...
        public override float getPlayfieldValue(Playfield p)
        {
            ...
            foreach (Minion m in p.ownMinions)
            {
                ...
                if (p.ownMinions.Count > 2 && (m.handcard.card.name == CardDB.cardName.direwolfalpha || m.handcard.card.name == CardDB.cardName.flametonguetotem || m.handcard.card.name == CardDB.cardName.stormwindchampion || m.handcard.card.name == CardDB.cardName.vessina)) retval += 10;
