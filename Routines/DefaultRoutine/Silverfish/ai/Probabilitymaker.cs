    ...
    public class SecretItem
    {
        ...
        public SecretItem(string secdata)
        {
            ...
            else if (canbe.Length == 15)
            {
                ...
                this.canBe_repentance = (canbe[12] == '1');
            ...
            if (enemyMinionsDiedStep.Count > 0)
            {
                ...
                else
                {
                    switch (enemyMinionsDiedStep[0].cardIDenum)
                    {
                        ...
                        case CardDB.cardIDEnum.EX1_556: redemption = false; break;
                        case CardDB.cardIDEnum.FP1_002: redemption = false; break;
                        case CardDB.cardIDEnum.FP1_007: redemption = false; break;
                        case CardDB.cardIDEnum.FP1_012: redemption = false; break;
                        case CardDB.cardIDEnum.GVG_096: redemption = false; break;
                        case CardDB.cardIDEnum.GVG_105: redemption = false; break;
